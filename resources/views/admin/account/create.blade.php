...
{{csrf_field()}}
                                      ...
                                      <div class="form-line">
                                        <span> <label for="acount_name">Account Name :</label></span>    <input type="text" name="account_name" id="account_name" class="form-control" placeholder="Enter your account name">
                                        </div>
                                    </div>
                                ...
                                <div class="col-sm-6">
                                        ...
                                        </span> <input type="text" name="account_description" id="account_description" class="form-control" placeholder="Give a Description">
                                 ...
                                 <div class="col-sm-6">
                                        ...
                                        <div class="form-line">
                                         ...
                                         text" name="amount" id="amount" class="form-control" placeholder="Enter your amount">
                                        </div>
                                    </div>
